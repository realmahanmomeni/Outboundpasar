...
import { Activity, CircleFadingArrowUp, Loader2, Map as MapIcon, MoreVertical, Package, Pencil, Power, PowerOff, RefreshCcw, RotateCcw, Settings, Trash2, WifiSync } from 'lucide-react'
              ...
              {canUpdate && (
                <>
                  ...
                  <DropdownMenuItem asChild>
                    <Link to={`/nodes/${node.id}`} onClick={e => e.stopPropagation()}>
                      <Settings className="mr-2 h-4 w-4 shrink-0" />
                      <span className="min-w-0 truncate">{t('nodes.manage', { defaultValue: 'Manage' })}</span>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onSelect={e => {
